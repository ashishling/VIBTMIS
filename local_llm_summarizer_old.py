...
"""
    ...
    def _query_ollama(self, prompt: str) -> str:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return self._query_ollama_generate(prompt)
            else:
    ...
    def _query_ollama_generate(self, prompt: str) -> str:
        """Fallback method using older Ollama generate API."""
        try:
            ...
            return f"Error with generate API: {e}"
...
def check_ollama_status() -> bool:
    ...
    try:
        # Try the newer version endpoint first
...
if __name__ == "__main__":
    # Example usage
    summarizer = LocalLLMSummarizer(backend="ollama", model="llama3.2")
